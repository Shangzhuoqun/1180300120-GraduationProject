...
; source id: tld-query-ren.-i.zdnscloud.com.
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 17539
...
;; WHEN: Sun Mar 06 20:53:54 ;; MSG SIZE  rcvd: 50
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 64373
;; flags: qr rd; QUERY: 1, ANSWER: 0, AUTHORITY: 0, ADDITIONAL: 1
;; WARNING: recursion requested but not available
