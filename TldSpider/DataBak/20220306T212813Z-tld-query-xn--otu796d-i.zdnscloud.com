...
; source id: tld-query-xn--otu796d.-i.zdnscloud.com.
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 3196
...
;; WHEN: Sun Mar 06 21:28:17 ;; MSG SIZE  rcvd: 50
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 58865
;; flags: qr rd; QUERY: 1, ANSWER: 0, AUTHORITY: 0, ADDITIONAL: 1
;; WARNING: recursion requested but not available
