...
; source id: tld-query-xn--30rr7y.-i.zdnscloud.com.
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 63926
...
;; WHEN: Sun Mar 06 21:21:01 ;; MSG SIZE  rcvd: 50
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 31327
;; flags: qr rd; QUERY: 1, ANSWER: 0, AUTHORITY: 0, ADDITIONAL: 1
;; WARNING: recursion requested but not available
