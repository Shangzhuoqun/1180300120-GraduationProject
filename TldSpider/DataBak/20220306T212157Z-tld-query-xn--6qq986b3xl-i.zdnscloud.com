...
; source id: tld-query-xn--6qq986b3xl.-i.zdnscloud.com.
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 59633
...
;; WHEN: Sun Mar 06 21:22:00 ;; MSG SIZE  rcvd: 50
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 43236
;; flags: qr rd; QUERY: 1, ANSWER: 0, AUTHORITY: 0, ADDITIONAL: 1
;; WARNING: recursion requested but not available
