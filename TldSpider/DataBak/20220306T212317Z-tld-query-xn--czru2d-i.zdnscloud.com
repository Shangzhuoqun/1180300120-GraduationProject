...
; source id: tld-query-xn--czru2d.-i.zdnscloud.com.
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 40506
...
;; WHEN: Sun Mar 06 21:23:20 ;; MSG SIZE  rcvd: 50
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: REFUSED, id: 48304
;; flags: qr rd; QUERY: 1, ANSWER: 0, AUTHORITY: 0, ADDITIONAL: 1
;; WARNING: recursion requested but not available
